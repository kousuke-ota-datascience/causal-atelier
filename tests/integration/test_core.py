...
from ariadne.infrastructure.config import hash_mapping, load_yaml_mapping
from ariadne.preprocessing.common import FeatureRole, FeatureSemanticSpec, FeatureSemanticsCatalog
...
def test_shared_layer_does_not_import_application_or_causal_packages() -> None:
    ...
    for path in (PROJECT_ROOT / "src/ariadne/shared").rglob("*.py"):
