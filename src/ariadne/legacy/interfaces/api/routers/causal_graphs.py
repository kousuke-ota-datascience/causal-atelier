...
from ariadne.application.run_execution.services import add_audit, canonical_hash
...
from ariadne.interfaces.api.schemas import CausalGraphCreate, CausalGraphVersionCreate
...
def create_causal_graph_version(
    ...
    stage = get_or_404(session, m.StageExecution, discovery.stage_execution_id)
