...
固定値は `00_variable_conventions.md` に従う。特に Completion Report の artifact naming には `ENHANCE_SHORT_ID` を使用する。
...
Browser E2EがGate-wide self-verificationに含まれる場合は、06 / P00で定義されたcritical journeyとcanonical commandだけを実行し、detailed specification proofのためにBrowser E2E scopeを拡張しない。failure時はfailure point / observable state / relevant logs等を記録し、product / test implementation / orchestration / environmentのいずれかを未検証のまま決めつけない。Candidate Assembly Agent自身でproduction / automated test / orchestrationを修正してはならない。
...
```text
ENH-E6-{{GATE_ID}}_{{TRIAL_NO}}_implementation_completion.md
ENH-E6-{{GATE_ID}}_{{TRIAL_NO}}__implementation_complete.md
ENH-E6-{{GATE_ID}}_{{TRIAL_NO}}__completion.md
E6_{{GATE_ID}}_{{TRIAL_NO}}__implementation_completion.md
...
```bash
COMPLETION_REPORT="docs/wiki/develop_memo/_work/20260813_ENH-E6_family_stage_navigation_bugfix/20_implementation_reports/{{GATE_ID}}/Trial{{TRIAL_NO}}/E6-{{GATE_ID}}_{{TRIAL_NO}}__implementation_completion.md"
...
```bash
find \
  "docs/wiki/develop_memo/_work/20260813_ENH-E6_family_stage_navigation_bugfix/20_implementation_reports/{{GATE_ID}}/Trial{{TRIAL_NO}}" \
  -maxdepth 2 \
  -type f \
...
E6-G12_03__implementation_completion.md
```

1行で表すと、

```text
docs/wiki/develop_memo/_work/20260813_ENH-E6_family_stage_navigation_bugfix/20_implementation_reports/G12/Trial03/E6-G12_03__implementation_completion.md
```

以下は誤りである。

```text
docs/wiki/develop_memo/_work/20260813_ENH-E6_family_stage_navigation_bugfix/20_implementation_reports/G12/Trial03/packages/E6-G12_03__implementation_completion.md
```

```text
docs/wiki/develop_memo/_work/20260813_ENH-E6_family_stage_navigation_bugfix/20_implementation_reports/G12/Trial03/E6-G12_3__implementation_completion.md
```

```text
docs/wiki/develop_memo/_work/20260813_ENH-E6_family_stage_navigation_bugfix/20_implementation_reports/G12/Trial03/E6-G12-03__implementation_completion.md
```
...
- COMPLETION_REPORT:
  docs/wiki/develop_memo/_work/20260813_ENH-E6_family_stage_navigation_bugfix/20_implementation_reports/<GATE_ID>/Trial<TRIAL_NO>/E6-<GATE_ID>_<TRIAL_NO>__implementation_completion.md
...
docs/wiki/develop_memo/_work/20260813_ENH-E6_family_stage_navigation_bugfix/
10_enhance_instruction/{{GATE_ID}}/
08_ENH-E6_{{GATE_ID}}_{{TRIAL_NO}}_Remediation_Instruction.md
```
