# G4 Trial 001 Test 006 — metric_task_compatibility_and_diagnostics
...
Classification/regression metrics、diagnostics、status separation を検証する。

## Acceptance Criteria

テスト指示書 G4-006 記載の全項目。
