# G4 Trial 001 Test 012 — full_active_pytest
...
Full active pytest を完走して repository-wide regression を検証する。

## Acceptance Criteria

`uv run pytest -q` が中断なく全 PASS する。
...
テスト指示書 §14 により高コスト full pytest は未実行。
