# G4 Trial 001 Test 004 — model_training_and_validation_selection
...
Classification/regression training、validation selection、determinism を検証する。

## Acceptance Criteria

テスト指示書 G4-004 記載の全項目。

## Preconditions / Environment

Cheap static coverage audit で G4-009 の必須 coverage 欠落を検出。
...
テスト指示書 §14 の fail-fast 規則により未実行。
