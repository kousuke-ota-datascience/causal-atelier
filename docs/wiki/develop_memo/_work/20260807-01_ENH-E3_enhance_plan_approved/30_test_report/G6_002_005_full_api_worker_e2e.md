# G6 Trial 002 Test 005 — full_api_worker_e2e
...
Full API/worker flowを検証する。

## Acceptance Criteria

Canonical `tests/product/test_enh_e3_api_worker_e2e.py`の完走。

## Commands Executed

```bash
# NOT RUN: blocked by G6-007 test assertion ambiguity.
```
