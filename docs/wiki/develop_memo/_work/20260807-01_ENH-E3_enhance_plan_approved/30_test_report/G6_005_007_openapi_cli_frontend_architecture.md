# G6 Trial 005 Test 007 — openapi_cli_frontend_architecture
...
G6 Trial 005 の openapi_cli_frontend_architecture 契約を検証する。
...
- Architecture, frontend, CLI contracts passed; compileall and node check exit 0.
