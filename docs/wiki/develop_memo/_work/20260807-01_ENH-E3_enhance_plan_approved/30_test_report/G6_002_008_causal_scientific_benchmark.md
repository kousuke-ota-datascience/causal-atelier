# G6 Trial 002 Test 008 — causal_scientific_benchmark
...
Causal scientific benchmark全体を再実行する。

## Acceptance Criteria

identification、eligibility、estimator gate、RERUN/REVISED、post-discovery warning、scientific status semantics。

## Commands Executed

```bash
# NOT RUN: blocked before scientific stage.
```
