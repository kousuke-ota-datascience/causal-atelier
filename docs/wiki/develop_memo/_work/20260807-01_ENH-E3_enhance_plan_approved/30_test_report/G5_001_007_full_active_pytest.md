# G5 Trial 001 Test 007 — full_active_pytest
...
~~~bash
# NOT RUN: stopped by required coverage failure.
~~~
...
Fail-fast prohibits full pytest after the Gate was already deterministically failed by missing required coverage.
