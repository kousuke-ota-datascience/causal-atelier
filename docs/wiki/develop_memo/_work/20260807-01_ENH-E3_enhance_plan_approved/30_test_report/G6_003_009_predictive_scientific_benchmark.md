# G6 Trial 003 Test 009 — predictive_scientific_benchmark
...
Predictive scientific benchmarkを再実行する。

## Acceptance Criteria

leakage prevention、train-only fit、test isolation、reproducibility、metric sanity、explanation labeling。

## Commands Executed

```bash
# NOT RUN: stopped by G6-007 regression.
```
