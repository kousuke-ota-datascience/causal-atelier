# ENH-E7 G01 P02 — Projects / New Project Surface
...
Project ListとNew Projectをroute-backedな別surfaceとして成立させる。
...
- Project Listを`/projects`に配置
- Project Registerを`/projects/new`に配置
- 作成成功後`/projects/<new_id>/overview`へ遷移
- cancelで`/projects`へ戻る

## 4. Explicitly out of scope

- Project Archiveをglobal list responsibilityへ置かない。
- Analysis navigationを追加しない。
...
- `G01/P02/Trial01`のAgent Execution ReadinessがPASS。
...
|---|---|---|
| focused product test | `uv run pytest -q tests/product/test_enh_e7_g01_p02_projects_new_project_surface.py` | PASS |
...
ENH-E7_G01_P02_Trial<TRIAL_NO>_package_execution_status.md
```
...
Project list/create focused testがPASSする。
