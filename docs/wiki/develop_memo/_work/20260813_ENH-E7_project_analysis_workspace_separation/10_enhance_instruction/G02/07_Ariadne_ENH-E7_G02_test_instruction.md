...
|---|---|---|
| 001 | `candidate_identity` | `30_test_report/G02/Trial<TRIAL_NO>/ENH-E7_G02_Trial<TRIAL_NO>_001_candidate_identity.md` |
| 002 | `analysis_context_contract` | `30_test_report/G02/Trial<TRIAL_NO>/ENH-E7_G02_Trial<TRIAL_NO>_002_analysis_context_contract.md` |
| 003 | `analysis_navigation_contract` | `30_test_report/G02/Trial<TRIAL_NO>/ENH-E7_G02_Trial<TRIAL_NO>_003_analysis_navigation_contract.md` |
| 004 | `causal_stage_operability` | `30_test_report/G02/Trial<TRIAL_NO>/ENH-E7_G02_Trial<TRIAL_NO>_004_causal_stage_operability.md` |
| 005 | `exploratory_stage_operability` | `30_test_report/G02/Trial<TRIAL_NO>/ENH-E7_G02_Trial<TRIAL_NO>_005_exploratory_stage_operability.md` |
| 006 | `predictive_stage_semantics` | `30_test_report/G02/Trial<TRIAL_NO>/ENH-E7_G02_Trial<TRIAL_NO>_006_predictive_stage_semantics.md` |
| 007 | `legacy_and_cross_surface_routing` | `30_test_report/G02/Trial<TRIAL_NO>/ENH-E7_G02_Trial<TRIAL_NO>_007_legacy_and_cross_surface_routing.md` |
| 008 | `analysis_main_browser_journey` | `30_test_report/G02/Trial<TRIAL_NO>/ENH-E7_G02_Trial<TRIAL_NO>_008_analysis_main_browser_journey.md` |
| 009 | `analysis_history_compat_browser` | `30_test_report/G02/Trial<TRIAL_NO>/ENH-E7_G02_Trial<TRIAL_NO>_009_analysis_history_compat_browser.md` |

各Test Item reportは最低限以下を本文内に持つ。

```text
# ENH-E7 G02 Trial<TRIAL_NO> Test Item <TEST_ITEM_ID> — <TEST_ITEM_NAME>
...
```text
30_test_report/G02/Trial<TRIAL_NO>/
ENH-E7_G02_Trial<TRIAL_NO>_999_gate_decision.md
```

必須内容:

```text
# ENH-E7 G02 Trial<TRIAL_NO> Test Item 999 — Gate Decision
