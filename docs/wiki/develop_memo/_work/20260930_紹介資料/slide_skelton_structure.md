...
[スライドを提示しながら口頭で説明する内容を、必要に応じてそのまま読み上げられる台本として記述する]
...
- 発表者がスライド表示中に参照する説明台本として扱い、**原則としてそのまま読み上げても顧客向け説明として成立する話し言葉で記述する**。
- Chartの読み方、重要な前提、誤解しやすい点、補足例等を記述する。
- スライド上の情報量を増やす代わりにSpeaker Noteで補う。
- スライド設計者向けのメタ説明、他スライドとの役割分担、編集方針は原則としてSpeaker Noteへ混在させない。
