# 10 要件定義 — ENH-E4 approved target snapshot
...
> **本書はAriadne ENH-E4承認後の機能要件、非機能要件および分析上のtarget contractを定義するsnapshotである。**
>
...
| NFR-019 | Documentation | ENH-E4 approved target snapshotと関連正本文書だけで機能・データ・API・詳細設計を理解できる |
