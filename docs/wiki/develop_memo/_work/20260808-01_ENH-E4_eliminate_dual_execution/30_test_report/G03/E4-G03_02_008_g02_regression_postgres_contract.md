# E4-G03 Trial 02 Test 008 — G02 Regression and PostgreSQL Contract
...
Verify G02 canonical execution, claim, lease, retry, and PostgreSQL contracts are preserved.

## 2. Acceptance Criteria

E4-G03-AC-005; passed-G02 regression boundary.
...
Real isolated PostgreSQL `database_test`.
...
The aggregate output reports 22 passed; it includes `test_postgres_contract.py` and `test_enh_e4_g02_canonical_execution.py`.
...
G02 regression and the atomic concurrent-claim PostgreSQL contract passed under the G03 migration head.
...
All requested tests pass after reset and Product migration, and the runner propagates exit 0.

## 11. Decision Rationale

The passed G02 contract remains intact in the same standardized execution.
...
The runner recorded service/image, commit, command, timestamps, raw output path, and exit status in its metadata file.
