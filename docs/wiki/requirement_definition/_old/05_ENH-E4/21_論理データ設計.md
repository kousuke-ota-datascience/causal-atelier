# 21 論理データ設計 — ENH-E4 approved target snapshot
...
- 更新日: 2026-08-07
- 上位文書: `10_要件定義.md`
- 対象: pre-ENH-E4 baseline logical data model, normalized by the ENH-E4 target contract
...
### 12.6. ENH-E4 Result semantic level and logical ownership
...
+
### 12.7. ENH-E4 relation-level lineage authority allowlist
